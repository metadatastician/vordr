...
image:https://api.scorecard.dev/projects/github.com/metadatastician/vordr/badge[OpenSSF Scorecard,link="https://scorecard.dev/viewer/?uri=github.com/metadatastician/vordr"]
